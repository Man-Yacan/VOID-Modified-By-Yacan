...
class Utils
{
    ...
    {
        echo '<script src="';
        self::indexTheme('https://cdn.manyacan.com/blog/assets/libs/owo/owo_02.js');
        echo '"></script>';

        echo '<script src="';
        self::indexTheme('https://cdn.manyacan.com/blog/assets/editor-d6bdd77f4b.js');
        echo '"></script>';

        echo '<link rel="stylesheet" href="';
        self::indexTheme('https://cdn.manyacan.com/blog/assets/libs/owo/owo.min.css');
        echo '" />';
