...
Class Contents
{
    ...
    {
        return '<img class="biaoqing" src="https://cdn.manyacan.com/blog/assets/libs/owo/biaoqing/paopao/'. str_replace('%', '', urlencode($match[1])) . '_2x.png">';
    }
    ...
    {
        return '<img class="biaoqing" src="https://cdn.manyacan.com/blog/assets/libs/owo/biaoqing/aru/'. str_replace('%', '', urlencode($match[1])) . '_2x.png">';
    }
    ...
    {
        return '<img class="biaoqing" src="https://cdn.manyacan.com/blog/assets/libs/owo/biaoqing/quyin/'. str_replace('%', '', urlencode($match[1])) . '.png">';
    }
