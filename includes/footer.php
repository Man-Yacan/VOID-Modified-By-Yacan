...
<footer>
    <div class="container wide">
        <section>
            <p>© 2017-
                <?php echo date('Y '); ?> <a
                    href="https://blog.manyacan.com/readme.html"><span>关于本站</span></a>&nbsp;&middot;&nbsp;<a
                    href="https://manyacan.com/typecho">Typecho</a>&nbsp;&middot;&nbsp;<a
                    href="https://blog.imalan.cn/archives/247/">VOID</a>
            </p>
            <p><span class="uptime"></span></p>
            <!--数据库查询所有文章浏览数总和-->
            <p>总访问量：
                <?php echo get_sum_view_num(); ?>次&nbsp;&middot;&nbsp;<a
                    href="https://v6.51.la/user/application">站长统计</a>
            <p>
        </section>
        <section>
            <p><a href="http://www.beian.gov.cn/portal/registerSystemInfo" target="_blank"><img class="ipc-icon"
                        src="https://image.manyacan.com/202211180944023.svg" alt="">&nbsp;&middot;&nbsp;豫公网安备41042102000030号</a></p>
            <p><a href="http://www.beian.miit.gov.cn/" target="_blank"><img class="ipc-icon"
                        src="https://image.manyacan.com/202211180943228.svg" alt="">&nbsp;&middot;&nbsp;豫ICP备20011308号</a></p>
            <p><a href="http://creativecommons.org/licenses/by-nc-sa/4.0/"><img
                        alt="" src="https://image.manyacan.com/by-nc-nd.png" />&nbsp;&middot;&nbsp;CC BY-NC-SA 4.0</a></p>
        </section>
    </div>
</footer>
...
<aside id="ctrler-panel">
    ...
    <div class="ctrler-item hidden-xs">
        <a target="_blank" aria-label="进入后台" href="<?php $this->options->adminUrl(); ?>"
            style="transform: translateX(-2px);"><i class="voidicon-login"></i></a>
    </div>
    <div class="ctrler-item hidden-xs">
        <a target="_blank" aria-label="管理评论" href="<?php $this->options->adminUrl('manage-comments.php'); ?>"
            style="transform: translateX(-2px);"><i class="voidicon-comment"></i></a>
    </div>
    <?php endif; ?>
...
<aside hidden id="setting-panel">
        ...
        <div id="adjust-text-container">
            ...
            <div class="adjust-text-item">
                <a target="_self" class="font-indicator <?php if (!Utils::isSerif($setting))
                            echo ' checked'; ?>"
                    href="javascript:void(0)" onclick="VOID_Ui.toggleSerif(this, false);">Sans</a>
                <a target="_self" class="font-indicator <?php if (Utils::isSerif($setting))
                            echo ' checked'; ?>"
                    href="javascript:void(0)" onclick="VOID_Ui.toggleSerif(this, true);">Serif</a>
            </div>
        </div>
    </section>
    <section id="links">
        ...
        <?php endif; ?>
        <a class="link" title="RSS" target="_blank" href="<?php $this->options->feedUrl(); ?>"><i
    ...
    <section id="login-panel" <?php if ($this->user->hasLogin())
        ...
        <div class="buttons" id="manage-buttons">
            ...
            <a class="btn btn-normal" no-pjax title="登出" onclick="VOID_Ui.rememberPos()"
                href="<?php $this->options->logoutUrl(); ?>">登出</a>
        </div>
        <?php endif; ?>
    </section>
</aside>
...
<script>
    ...
    for (var day of days) {
        var d = day.split('.');
        if (mon == d[0] && date == d[1]) {
            VOID.alert('<h4>今天是国家纪念日</h4>\n<span>历史不会忘记，人民永远铭记！</span>');
